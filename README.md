...
- [Starter template](https://micronaut.io/launch/)
...
- docker build -t micronaut-kotlin .
- docker run -p 8080:8080 micronaut-kotlin


Micronaut starter template : https://micronaut.io/launch/